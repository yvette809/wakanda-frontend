...
<Container className= "dashboard_container">
  <div className="large text-primary">
    ...
    className="mb-2"
     ...
     (<h2>I am <strong>{user.name}</strong>. I am the Admin, Treasurer and Web Master of WSK klub.Direct questions about the website's functionality to me</h2>):
     
     ( <h1 className= "dashboard">
      Welcome {user && user.name} !! You are
